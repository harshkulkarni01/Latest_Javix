...
public class ViewScreenerProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_screener_profile);
        downloadJSON();
        ...
        mImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CropImage.activity()
                        ...
                        .start(ViewScreenerProfileActivity.this);
    ...
    private void downloadJSON() {
        ...
        class DownloadJSON extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loadingDialog = ProgressDialog.show(ViewScreenerProfileActivity.this, "Please wait", "Loading...");
            }
    ...
    class SubmitForm extends AsyncTask<String, Void, String>{
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                int respStatus=jsonObject.getInt("status");
                if(respStatus==1) {
                    //Intent i = new Intent(ViewScreenerProfileActivity.this, CitizenAddedSussfully.class);
                    //startActivity(i);
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                ...
                runOnUiThread(new Runnable() {
                    public void run() {
                        Toast.makeText(ViewScreenerProfileActivity.this, "MalformedURLException" + ex.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
                ...
                runOnUiThread(new Runnable() {
                    public void run() {
                        Toast.makeText(ViewScreenerProfileActivity.this, ImagePath,
        ...
        protected void onPostExecute(String result) {
            ...
            if (jsonStr != null) {
                try {
                    ...
                    Toast.makeText(ViewScreenerProfileActivity.this, "File Uploaded Successfully ",
                            Toast.LENGTH_SHORT).show();
    ...
    private void saveToInternalStorage(Bitmap bitmapImage){
        ...
        if(isStoragePermissionGranted()) {
            ...
            try {
                ...
                Toast.makeText(ViewScreenerProfileActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                e.printStackTrace();
            }
        }
    }
    ...
    void DownloadImage() {
        if (ContextCompat.checkSelfPermission(ViewScreenerProfileActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED &&
                ContextCompat.checkSelfPermission(ViewScreenerProfileActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(ViewScreenerProfileActivity.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, 123);
            ActivityCompat.requestPermissions(ViewScreenerProfileActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 123);
        }
    }
