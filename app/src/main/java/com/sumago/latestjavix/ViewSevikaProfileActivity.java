...
public class ViewSevikaProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_sevika_profile);
        ...
        mImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CropImage.activity()
                        ...
                        .start(ViewSevikaProfileActivity.this);
    ...
    private void downloadJSON() {
        ...
        class DownloadJSON extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loadingDialog = ProgressDialog.show(ViewSevikaProfileActivity.this, "Please wait", "Loading...");
            }
                ...
                try {
                    ...
                    if(respStatus==1) {
                        ...
                        for(int i=0;i<recsLen;i++) {
                            ...
                            txName.setText("Name : " +  rec.getString("firstName") + " " + rec.getString("lastName"));
                            txEmail.setText("Email : " + rec.getString("email"));
                            txMobile.setText("Mobil : " + rec.getString("mobile"));
            ...
            protected String doInBackground(Void... voids) {
                ...
                try {
                    URL url = new URL(MyConfig.URL_SCREENER_PROFILE);
    ...
    void submitForm(){
        ...
        paramHash.put("roleId","2");
        paramHash.put("id",Config._screenerid);
    ...
    class SubmitForm extends AsyncTask<String, Void, String>{
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                int respStatus=jsonObject.getInt("status");
                if(respStatus==1) {
                    //Intent i = new Intent(ViewSevikaProfileActivity.this, CitizenAddedSussfully.class);
                    //startActivity(i);
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                ...
                runOnUiThread(new Runnable() {
                    public void run() {
                        Toast.makeText(ViewSevikaProfileActivity.this, "MalformedURLException" + ex.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
                ...
                runOnUiThread(new Runnable() {
                    public void run() {
                        Toast.makeText(ViewSevikaProfileActivity.this, ImagePath,
        ...
        protected void onPostExecute(String result) {
            ...
            if (jsonStr != null) {
                try {
                    ...
                    Toast.makeText(ViewSevikaProfileActivity.this, "File Uploaded Successfully ",
                            Toast.LENGTH_SHORT).show();
    ...
    private void saveToInternalStorage(Bitmap bitmapImage){
        ...
        if(isStoragePermissionGranted()) {
            ...
            try {
                ...
                Toast.makeText(ViewSevikaProfileActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                e.printStackTrace();
            }
        }
    }
    ...
    void DownloadImage() {
        if (ContextCompat.checkSelfPermission(ViewSevikaProfileActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED &&
                ContextCompat.checkSelfPermission(ViewSevikaProfileActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(ViewSevikaProfileActivity.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, 123);
            ActivityCompat.requestPermissions(ViewSevikaProfileActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 123);
        }
    }
